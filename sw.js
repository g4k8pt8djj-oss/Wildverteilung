const CACHE='wildverteilung-0153-test5';
self.addEventListener('install',e=>{self.skipWaiting();e.waitUntil(caches.open(CACHE).then(c=>c.addAll(['./','index.html','style.css?v=0153t5','app.js?v=0153t5','manifest.json']))) });
